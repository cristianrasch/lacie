...
class LacieTest < CapybaraTestCase
  ...
  def test_activities_2012
    ...
    assert_match page.find('ul.nav-tabs li.active').text, /2012/
  end
  ...
  def test_activities_2011
    ...
    assert_equal "Actividades", page.find('ul.nav-list li.active').text
    assert_match page.find('ul.nav-tabs li.active').text, /2011/
  end
  ...
  def test_activities_2010
    ...
    assert_equal "Actividades", page.find('ul.nav-list li.active').text
    assert_match page.find('ul.nav-tabs li.active').text, /2010/
  end
  ...
  def test_activities_2009
    ...
    assert_equal "Actividades", page.find('ul.nav-list li.active').text
    assert_match page.find('ul.nav-tabs li.active').text, /2009/
  end
  ...
  def test_activities_2008
    ...
    assert_equal "Actividades", page.find('ul.nav-list li.active').text
    assert_match page.find('ul.nav-tabs li.active').text, /2008/
  end
  ...
  def test_activities_2007
    ...
    assert_equal "Actividades", page.find('ul.nav-list li.active').text
    assert_match page.find('ul.nav-tabs li.active').text, /2007/
  end
  ...
  def test_activities_2005_2006
    ...
    assert_equal "Actividades", page.find('ul.nav-list li.active').text
    assert_match page.find('ul.nav-tabs li.active').text, /2005-2006/
  end
  ...
  def test_kits
    ...
    assert_equal "Instrumental", page.find('ul.nav-list li.active').text
    assert page.has_css?('ul.nav-tabs li.active')
    assert_match page.find('ul.nav-tabs li.active').text, /kits/i
  end
  ...
  def test_machines
    ...
    assert_equal "Instrumental", page.find('ul.nav-list li.active').text
    assert page.has_css?('ul.nav-tabs li.active')
    assert_match page.find('ul.nav-tabs li.active').text, /máquinas/i
  end
  ...
  def test_bylaws
    ...
    assert find("div#objetivo").visible?
  end
